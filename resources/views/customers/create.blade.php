                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input name="first_name" value="{{ old('first_name') }}" placeholder="Enter first name" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('first_name') border-red-500 ring-2 ring-red-200 @enderror">
                                    @error('first_name')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input name="last_name" value="{{ old('last_name') }}" placeholder="Enter last name" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('last_name') border-red-500 ring-2 ring-red-200 @enderror">
                                    @error('last_name')
                                        <p class="text-red-500 text-sm mt-1 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input name="phone" type="tel" value="{{ old('phone') }}" placeholder="+1234567890" class="border border-gray-300 rounded-lg pl-10 pr-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('phone') border-red-500 ring-2 ring-red-200 @enderror">
                                    @error('phone')
                                        <p class="text-red-500 text-sm mt-1 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input name="whatsapp_number" type="tel" value="{{ old('whatsapp_number') }}" placeholder="+1234567890" class="border border-gray-300 rounded-lg pl-10 pr-4 py-3 w-full focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all @error('whatsapp_number') border-red-500 ring-2 ring-red-200 @enderror">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input name="city" value="{{ old('city') }}" placeholder="Enter city" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Province</label>
                                <input name="province" value="{{ old('province') }}" placeholder="Enter province/state" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Zip Code</label>
                                <input name="zip_code" value="{{ old('zip_code') }}" placeholder="Enter zip/postal code" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Country <span class="text-red-500">*</span>
                                </label>
                                <input name="country" value="{{ old('country') }}" placeholder="Enter country" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('country') border-red-500 ring-2 ring-red-200 @enderror">
                                @error('country')
                                    <p class="text-red-500 text-sm mt-1 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input name="payment_amount" type="number" min="0" step="0.01" value="{{ old('payment_amount') }}" placeholder="0.00" class="border border-gray-300 rounded-lg pl-12 pr-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('payment_amount') border-red-500 ring-2 ring-red-200 @enderror">
                                    ...
                                    @foreach($publications as $publication)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="checkbox" id="pub_{{ $publication->id }}" name="publications[{{ $publication->id }}][selected]" value="1" class="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500 transition-all cursor-pointer">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
