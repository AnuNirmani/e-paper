                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input name="last_name" inputmode="text" pattern="[A-Za-z\s]*" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'');" value="{{ old('last_name', $customer->last_name) }}" placeholder="Enter last name" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('last_name') border-red-500 ring-2 ring-red-200 @enderror">
                                    @error('last_name')
                                        <p class="text-red-500 text-sm mt-1 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input name="order_id" value="{{ old('order_id', $customer->order_id) }}" placeholder="Enter order ID" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('order_id') border-red-500 ring-2 ring-red-200 @enderror">
                                    @error('order_id')
                                        <p class="text-red-500 text-sm mt-1 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input name="city" inputmode="text" pattern="[A-Za-z\s]*" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'');" value="{{ old('city', $customer->city) }}" placeholder="Enter city" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Province</label>
                                <input name="province" inputmode="text" pattern="[A-Za-z\s]*" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'');" value="{{ old('province', $customer->province) }}" placeholder="Enter province/state" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Zip Code</label>
                                <input name="zip_code" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" value="{{ old('zip_code', $customer->zip_code) }}" placeholder="Enter zip/postal code" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Country <span class="text-red-500">*</span>
                                </label>
                                <input name="country" inputmode="text" pattern="[A-Za-z\s]*" oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'');" value="{{ old('country', $customer->country) }}" placeholder="Enter country" class="border border-gray-300 rounded-lg px-4 py-3 w-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('country') border-red-500 ring-2 ring-red-200 @enderror">
                                @error('country')
                                    <p class="text-red-500 text-sm mt-1 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="payment_amount" id="payment_amount_input"
                                    ...
                                    value="{{ old('payment_amount', $customer->payment_amount) }}" placeholder="0.00">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
